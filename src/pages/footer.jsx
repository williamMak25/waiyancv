...
export const Footer = () => {
  return (
    <div className='bg-violet-900 flex flex-col items-center justify-center py-5'>
        <p className='text-white text-center'>You can contact me from my social media accounts/ email or click contact me button to take token and I will contact later.</p>
