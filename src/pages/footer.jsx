...
export const Footer = () => {
  return (
    <div className='bg-violet-900 flex flex-col items-center justify-center py-5 m-0'>
        <p className='text-white text-center mx-3'>You can contact me from my social media accounts/ email</p>
